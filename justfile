run *ARGS:
  python -m scripts.evaluate --algo afu --env pendulum --experiment onpolicy --run 11 --steps 1000000 --trials 0

run-tiny:
  python -m scripts.evaluate --algo afu --env pendulum --experiment onpolicy --run 1 --steps 1024 --trials 0
