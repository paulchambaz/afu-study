run *ARGS:
  python -m scripts.evaluate --algo ddpg --env pendulum --experiment onpolicy --run 5 --steps 200000 --trials 0
  python -m scripts.evaluate --algo sac --env pendulum --experiment onpolicy --run 5 --steps 200000 --trials 0
  python -m scripts.evaluate --algo afu --env pendulum --experiment onpolicy --run 5 --steps 200000 --trials 0
