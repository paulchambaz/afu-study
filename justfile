run *ARGS:
  python -m scripts.evaluate --algo iql --env lunarlander --experiment onpolicy --run 5 --steps 200000 --trials 0

run-tiny:
  python -m scripts.evaluate --algo iql --env lunarlander --experiment onpolicy --run 1 --steps 1024 --trials 0
