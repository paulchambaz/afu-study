run *ARGS:
  python -m scripts.evaluate --algo iql --env pendulum --experiment offline --run 5 --steps 100000 --trials 0

run-tiny:
  python -m scripts.evaluate --algo iql --env pendulum --experiment offline --run 1 --steps 400 --trials 0
