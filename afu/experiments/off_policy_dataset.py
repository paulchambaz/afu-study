...
class OffPolicyDataset(Experiment):
    def run(self, i, shared_results, results_lock, manager):
        ...
        while training_steps < self.params.total_steps:
            ...
            if training_steps % self.params["interval"] == 0:
                eval_results, eval_transitions = self.evaluation(agent)
                transitions.extend(eval_transitions)
        ...
        with results_lock:
            ...
            shared_results["transitions"] = transitions
