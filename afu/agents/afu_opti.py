...
class AFUOpti:
    def __init__(self, hyperparameters: OmegaConf, optimal_model: dict):
        ...
        # self.optimal_v_network1 = optimal_model["v_network1_state"]
        # self.optimal_v_network2 = optimal_model["v_network2_state"]
        # self.optimal_a_network1 = optimal_model["a_network1_state"]
        # self.optimal_a_network2 = optimal_model["a_network2_state"]
        ...
        self.optimal_q_network = QNetwork(
            state_dim=self.state_dim,
            hidden_dims=hidden_dims,
            action_dim=self.action_dim,
        )
        self.optimal_q_network.load_state_dict(optimal_model["q_network_state"])
    ...
    def _compute_q_loss(
        ...
        self.optimal_q_network(workspace, t=0)
    ...
    def _compute_policy_loss(self, states: torch.Tensor) -> torch.Tensor:
        ...
        self.optimal_q_network(q_workspace, t=0)
    ...
    @classmethod
    def loadagent(cls, path: str) -> "AFUOpti":
        save_dict = torch.load(path)
